	...
	<body>
		...
		<form action="index.php" method="post">
			<table cellpadding="5" align="center" cellpadding="2" border="7">
				<center><H1>ENKRIPSI DAN DEKRIPSI</H1></center>
				<tr>
					<td align="center">Key: <input type="text" placeholder="key" name="key" id="pass" value="<?php echo htmlspecialchars($key); ?>" /></td>
				</tr>
				<tr>
					<td align="center"><textarea id="box" placeholder="Masukkan pesan yang akan dienkripsi" name="code"><?php echo htmlspecialchars($code); ?></textarea></td>
				</tr>
				<tr>
